    ...
    <div className="relative min-h-screen bg-transparent px-3 py-6 sm:px-6 lg:px-8">
      <div className="mx-auto flex max-w-7xl flex-col">
        ...
        <div className="mb-6 flex flex-wrap items-center justify-between gap-3">
          <button
            onClick={onBack}
            className="group inline-flex items-center gap-2 rounded-xl border border-stone-800 bg-stone-900/90 px-4 py-2.5 text-xs font-bold text-stone-100 shadow-md backdrop-blur-md transition-all hover:border-amber-500/50 hover:bg-stone-800 hover:text-amber-300 active:scale-95"
          >
        ...
        <AnimatePresence>
          {confirmedToast && (
            <motion.div
              ...
              exit={{ opacity: 0, y: -15 }}
              className="mb-6 flex items-center justify-between rounded-2xl border border-emerald-500/40 bg-emerald-500/10 p-4 text-xs font-semibold text-emerald-300 backdrop-blur-md"
            >
        ...
        <div className="order-3 relative mb-6 overflow-hidden rounded-3xl border border-stone-800 bg-gradient-to-r from-stone-900 via-stone-900/90 to-stone-950 p-6 shadow-2xl backdrop-blur-xl sm:p-8">
        ...
        <div className="order-2 mb-6 flex flex-col gap-4 rounded-2xl border border-stone-800 bg-stone-900/60 p-4 backdrop-blur-md">
            ...
            <div className="space-y-6">
              {(selectedLineId === 'all' ? city.lines : [currentLine!]).map((line) => {
                ...
                return (
                  <div
                    key={line.id}
                    className="rounded-3xl border border-stone-800 bg-stone-900/60 p-6 shadow-xl backdrop-blur-md"
                  >
