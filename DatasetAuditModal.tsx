    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-6">
        ...
        <motion.div
          ...
          className="relative max-h-[90vh] w-full max-w-4xl overflow-hidden rounded-3xl border border-stone-800 bg-stone-900 shadow-2xl backdrop-blur-xl ring-1 ring-white/10"
        >
          {/* Modal Header */}
