    ...
    >
      ...
      >
        ...
        <div className="absolute top-0 right-0 bottom-0 w-3/5 sm:w-1/2 overflow-hidden pointer-events-none">
          ...
          <div className="absolute top-12 right-12 z-20 flex items-center gap-3 rounded-lg border border-amber-500/50 bg-[#0d0f14] px-5 py-2.5 shadow-2xl shadow-black/80 md:bg-[#0d0f14]/95 md:backdrop-blur-md">
            {/* LAG FIX: intro chrome skips backdrop-blur on phones. */}
            {/* Round Metro Logo */}
        ...
        <div className="absolute inset-0 flex flex-col justify-between p-6 sm:p-12 lg:p-20 z-30 pointer-events-none">
          ...
          >
            {/* LAG FIX: intro pills skip backdrop-blur on phones. */}
            <div className="inline-flex items-center gap-2 rounded-full border border-amber-500/30 bg-stone-950 px-3.5 py-1 text-xs font-semibold text-amber-300 md:bg-stone-950/80 md:backdrop-blur-md">
            ...
            <button
              ...
              // LAG FIX: skip button is opaque on phones (no backdrop-blur).
              className="flex items-center gap-1.5 rounded-full border border-stone-700/80 bg-stone-900 px-4 py-1.5 text-xs font-semibold text-stone-200 md:bg-stone-900/90 md:backdrop-blur-md transition-all hover:border-amber-500/50 hover:bg-stone-800 hover:text-white cursor-pointer"
            >
