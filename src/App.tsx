...
export default function App() {
  ...
  // LAG FIX: phones fade only. Scaling the full India SVG / city view is a
  // major source of jank on mobile GPUs.
        ...
        <AnimatePresence>
          {selectedCity ? (
            <motion.div
              ...
              // LAG FIX: skip scale/translate on mobile — opacity-only transition.
              initial={isMobile ? { opacity: 0 } : { opacity: 0, scale: 0.96, y: 15 }}
              animate={isMobile ? { opacity: 1 } : { opacity: 1, scale: 1, y: 0 }}
              exit={isMobile ? { opacity: 0 } : { opacity: 0, scale: 1.04, y: -10 }}
            ...
            <motion.div
              ...
              // LAG FIX: do not scale the India map on enter/exit on phones.
              initial={isMobile ? { opacity: 0 } : { opacity: 0, scale: 1.03 }}
